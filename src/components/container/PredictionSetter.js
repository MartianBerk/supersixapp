...
class PredictionSetter extends Component {
    ...
    getMatches(matchDate) {
        ...
        fetch("http://192.168.0.37:5000/webapis/supersix/admin/listmatches?matchDate=" + matchDate)
    ...
    getRound() {
        fetch("http://192.168.0.37:5000/webapis/supersix/admin/getround")
        .then(response => response.json())
    ...
    getPlayers() {
        ...
        fetch("http://192.168.0.37:5000/webapis/supersix/admin/listplayers")
        .then(response => response.json())
    ...
    handleSubmit(event) {
        ...
        fetch("http://192.168.0.37:5000/webapis/supersix/admin/addpredictions", {
            method: "POST",
